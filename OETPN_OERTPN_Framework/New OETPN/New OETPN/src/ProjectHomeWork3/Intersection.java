...
public class Intersection {
	public static void main(String[] args) {
		...
		OP1.SetName("OP1");
		OP1.Value = new TransferOperation("localhost", "1091", "in1");
		...
		OP2.SetName("OP2");
		OP2.Value = new TransferOperation("localhost", "1091", "in2");
		...
		OP3.SetName("OP3");
		OP3.Value = new TransferOperation("localhost", "1091", "in3");
		...
		OP4.SetName("OP4");
		OP4.Value = new TransferOperation("localhost", "1091", "in4");
		...
		//Connect to RoundAbout
				DataTransfer PO4 = new DataTransfer();
				PO4.SetName("PO4");
				PO4.Value = new TransferOperation("localhost", "1092", "p5");
		...
		grdtu3.condition= T3Ct3;
		
		grdtu3.Activations.add(new Activation(t3, "full", TransitionOperation.SendOverNetwork, "OP2"));
		grdtu3.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Move,"P_a2"));
		...
		T3Ct3.SetNextCondition(LogicConnector.AND, T5Ct4);

		GuardMapping grdtu5 = new GuardMapping();
		grdtu5.condition= T5Ct3;
		
		grdtu5.Activations.add(new Activation(t5, "full", TransitionOperation.SendOverNetwork, "OP3"));
		grdtu5.Activations.add(new Activation(t5, "P_a3", TransitionOperation.Move,"P_a3"));
		...
		t7.InputPlaceName.add("P_x4");

		Condition T7Ct1 = new Condition(t7, "P_a4", TransitionCondition.NotNull);
		Condition T7Ct2 = new Condition(t7, "P_x4", TransitionCondition.CanAddCars);
		...
		//Add OP activations
				...
				grdtu7.condition= T7Ct3;
				
				grdtu7.Activations.add(new Activation(t7, "full", TransitionOperation.SendOverNetwork, "OP4"));
				grdtu7.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Move,"P_a4"));
				t7.GuardMappingList.add(grdtu7);
		...
		grdT21.Activations.add(new Activation(t21,"P_o4Exit",TransitionOperation.SendOverNetwork,"PO4"));
